 ...
 */
public class TelaBuscaPedidoCompra extends javax.swing.JFrame {

    /**
     * Creates new form TelaBuscaProjetos
     */
    public TelaBuscaPedidoCompra() {
        initComponents();
    }
    
    public void popularTabelaPedidoCompra(List<PedidoCompra> pclistaPedidoCompra){
        DefaultTableModel modeloTabela = new DefaultTableModel();
        this.tabelaPedidoCompra.setModel(modeloTabela);
        modeloTabela.addColumn("Id");
        modeloTabela.addColumn("id_projeto");
        modeloTabela.addColumn("id_cliente");
        modeloTabela.addColumn("data_emissao");
        modeloTabela.addColumn("valor total");
        
        for(PedidoCompra pc :pclistaPedidoCompra){
            modeloTabela.addRow(new Object[]{
                pc.getId_pedido_compra(),
                pc.getProjetos(),
                pc.getPessoa(),
                pc.getDt_emicao(),
                pc.getValor_total()
    ...
    private void initComponents() {
        ...
        btnBuscarPedidoCompra.setText("buscar PedidoCompra");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(btnBuscarPedidoCompra, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void btnBuscarPedidoCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarPedidoCompraActionPerformed
       ...
       /* Projetos p = new Projetos("itmbiara", "esteira", "esteira transportadora", "walter", "heitor", "oliveira", "tadeu");
        ...
        List<PedidoCompra> listaPedidoCompra = new ArrayList<>();
        listaPedidoCompra = PedidoCompraDAO.getInstance().findAll();
        this.popularTabelaPedidoCompra(listaPedidoCompra);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaPedidoCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaPedidoCompra().setVisible(true);
