 ...
 */
public class TelaBuscaInsumo extends javax.swing.JFrame {

    /**
     * Creates new form TelaBuscaProjetos
     */
    public TelaBuscaInsumo() {
        initComponents();
    }
    
    public void popularTabelaInsumo(List<Insumo> ilistaInsumo){
        DefaultTableModel modeloTabela = new DefaultTableModel();
        this.tabelaInsumo.setModel(modeloTabela);
        modeloTabela.addColumn("Id");
        modeloTabela.addColumn("Descricao produto");
        modeloTabela.addColumn("Codigo produto");
        modeloTabela.addColumn("Unidade");
        
        for(Insumo i :ilistaInsumo){
            modeloTabela.addRow(new Object[]{
                i.getId_insumo(),
                i.getDescricao_produto(),
                i.getCod_insumo(),
                i.getUnidade()
            });
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaInsumo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaInsumo().setVisible(true);
